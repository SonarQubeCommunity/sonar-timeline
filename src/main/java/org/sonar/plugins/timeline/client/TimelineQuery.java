...
public final class TimelineQuery extends AbstractResourceQuery<DataTable> {
  ...
  public static TimelineQuery get(String resourceKey) {
    return new TimelineQuery(resourceKey);
  }

  private TimelineQuery(String resourceKey) {
    super(resourceKey);
  }

  public TimelineQuery setMetrics(List<Metric> metrics) {
